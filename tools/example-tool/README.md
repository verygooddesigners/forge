...
- Displays user's project count
- Shows example of permission usage
- Demonstrates basic UI patterns
- Example of data storage

## Permissions

- `projects.read` - Used to count user's projects

## Installation

This tool is included as an example and can be installed from the Tools Marketplace.
...
├── README.md          # This file
└── index.tsx          # Main component (to be created after approval)
```
