...
export const architectureNodes: ArchitectureNode[] = [
  ...
  {
    id: 'nfl-odds',
    label: 'NFL Odds Extractor',
    type: 'frontend',
    description: 'Upload screenshots to auto-generate structured odds articles',
    features: [
      'Image upload',
  ...
  },
  {
    ...
    label: '/api/research/*',
    type: 'api',
    description: 'News search and fact verification endpoints',
    features: [
  ...
  {
    id: 'api-nfl',
    label: '/api/nfl-odds/extract',
    type: 'api',
    description: 'Visual data extraction from screenshots using Vision AI',
    features: [
      'Image processing',
      'OCR & data parsing',
      'Table generation',
  ...
  {
    id: 'agent-creative',
    label: 'Creative Features Agent',
    type: 'agent',
    description: 'Orchestrates complex workflows and creative tasks',
    features: [
...
export const architectureEdges: ArchitectureEdge[] = [
  ...
  { id: 'e-nfl-api', source: 'nfl-odds', target: 'api-nfl', label: 'Extract Data' },
  ...
  { id: 'e-nfl-visual', source: 'api-nfl', target: 'agent-visual', label: 'Extract' },
...
export const workflows: Workflow[] = [
  ...
  {
    id: 'nfl-odds',
    name: 'NFL Odds Extraction',
    description: 'Upload screenshots to auto-generate odds articles',
    nodeIds: [
      'nfl-odds',
      'api-nfl',
      'agent-visual',
    ...
    edgeIds: ['e-nfl-api', 'e-nfl-visual', 'e-visual-claude', 'e-visual-openai'],
    color: '#f59e0b',
  },
  {
    id: 'seo-optimization',
