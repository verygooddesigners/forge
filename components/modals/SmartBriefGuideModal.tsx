...
interface SmartBriefGuideModalProps {
  open: boolean;
...
export function SmartBriefGuideModal({ open, onOpenChange }: SmartBriefGuideModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!max-w-[85vw] !w-[85vw] max-h-[90vh] h-[90vh] overflow-hidden flex flex-col p-0 z-[9999]" showCloseButton={false}>
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Table of Contents */}
          <aside className="w-64 border-r border-border-default bg-bg-surface p-4 overflow-y-auto">
