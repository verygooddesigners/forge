...
export function EditorPanel({ projectId, writerModelId, onOpenProjectModal, onNewProject, onContentChange }: EditorPanelProps) {
  ...
  return (
    <>
      <div className="flex-1 bg-bg-elevated border border-border-subtle rounded-xl flex flex-col">
        ...
        {/* Status Bar */}
        <div className="border-t border-border-subtle bg-bg-surface px-4 py-2.5 text-xs text-text-secondary flex justify-between items-center">
