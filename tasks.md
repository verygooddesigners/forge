...
[] When content is generated by the Generate Content button, it's displaying as HTML code. I want it to display as formatted text, not code. *****
...
[] Writer Model Training: Need to be able to paste a URL to a story and have the AI extract 
