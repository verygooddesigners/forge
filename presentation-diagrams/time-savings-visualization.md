...
```mermaid
graph LR
    A[Week 1<br/>75 hrs] --> B[Month 1<br/>325 hrs]
    B --> C[Quarter 1<br/>975 hrs]
    C --> D[Year 1<br/>3,900 hrs]
    
    style D fill:#10b981,stroke:#059669,color:#fff,font-weight:bold
    style C fill:#a78bfa,stroke:#6d28d9,color:#fff
    style B fill:#c4b5fd,stroke:#6d28d9,color:#000
    style A fill:#e9d5ff,stroke:#6d28d9,color:#000
```
...
gantt
    ...
    Job Posting & Recruiting     :2024-01-01, 60d
    Interviews & Offers          :2024-03-01, 30d
