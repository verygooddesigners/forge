        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-900">App Overview</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <main className="min-w-0 flex-1">
            <article className="prose prose-slate max-w-none">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-semibold text-lg text-slate-900">Brief Builder</h4>
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-semibold text-lg text-slate-900">NewsEngine</h4>
                      </div>
                      <p className="text-slate-600 leading-relaxed">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-semibold text-lg text-slate-900">SEO Assistant</h4>
                      </div>
                      <p className="text-slate-600 leading-relaxed">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-semibold text-lg text-slate-900">Real-time Analysis</h4>
                      </div>
                      <p className="text-slate-600 leading-relaxed">
              ...
              <section id="complete-workflow" className="mb-16 scroll-mt-24">
                <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                  <Workflow className="h-7 w-7 text-violet-600" />
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="bg-violet-100 text-violet-700 rounded-full w-8 h-8 flex items-center justify-center font-bold flex-shrink-0">
                        1
                      </div>
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Create Project</h4>
                        <p className="text-slate-600 leading-relaxed">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Select Writer Model & Brief</h4>
                        <p className="text-slate-600 leading-relaxed">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Automatic Research</h4>
                        <p className="text-slate-600 leading-relaxed">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900 mb-1">Edit & Optimize</h4>
                        <p className="text-slate-600 leading-relaxed">
